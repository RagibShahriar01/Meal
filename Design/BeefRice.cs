...
{
    public partial class BeefRice : Form
    {
        private readonly int newUserId;
        private decimal basePrice = 110;
        private int quantity = 1;
        public BeefRice(int userId)
        {
            InitializeComponent();
            newUserId = userId;
        }

        private void BeefRice_Load(object sender, EventArgs e)
        {
        ...
        private void LblMinus_Click_1(object sender, EventArgs e)
        {
            if (quantity > 1)
            {
                quantity--;
